...
const GALLERY_DATA: GalleryItem[] = [
  {
    id: 1,
    src: `${url}/gallery/mail-club-concept/untitled-2.webp`,
    alt: 'Mail Club Concept 1',
  },
  {
    id: 2,
    src: `${url}/gallery/mail-club-concept/gift.webp`,
    alt: 'Mail Club Concept 2',
  },
]

const MailClubConcept = () => {
  return (
    <>
      <Navbar />
...
export default MailClubConcept
