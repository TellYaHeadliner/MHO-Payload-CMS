...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_media_category" AS ENUM('general', 'blog', 'gallery', 'branding');
  CREATE TYPE "public"."enum_gallery_music_source_type" AS ENUM('upload', 'url');
  ...
  CREATE TABLE "gallery" (
  	...
  	"title" varchar NOT NULL,
  	"description" varchar,
  	"music_source_type" "enum_gallery_music_source_type" DEFAULT 'upload',
  	"music_audio_file_id" integer,
  	"music_spotify_url" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "blog_gallery" ADD CONSTRAINT "blog_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "blog" ADD CONSTRAINT "blog_categories_id_categories_id_fk" FOREIGN KEY ("categories_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "gallery" ADD CONSTRAINT "gallery_music_audio_file_id_media_id_fk" FOREIGN KEY ("music_audio_file_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "blog_gallery_image_idx" ON "blog_gallery" USING btree ("image_id");
  CREATE INDEX "blog_categories_idx" ON "blog" USING btree ("categories_id");
  ...
  CREATE INDEX "gallery_music_music_audio_file_idx" ON "gallery" USING btree ("music_audio_file_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_gallery_music_source_type";`)
}
